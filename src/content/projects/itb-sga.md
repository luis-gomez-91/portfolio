...
features: [
  ...
  "Consultar calificaciones en tiempo real", 
  "Visualizar materias matriculadas", 
  "Revisar cursos asignados", 
  "Consultar docentes asignados", 
  "Acceder a horarios académicos", 
  "Realizar pagos en línea", 
  "Consultar información académica actualizada", 
  "Ver cronograma académico", 
  "Aceptar materias asignadas", 
  "Abrir clases programadas",
